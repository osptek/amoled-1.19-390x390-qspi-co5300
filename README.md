...
本仓库收录 **1.19 寸 390×390 AMOLED（QSPI · CO5300）** 显示模组资料。

**根目录 README 为导航页**。下表可快速浏览各版本；点击「完整资料」进入 `versions/` 下对应**料号文件夹**（产品页、规格书、示例均在该目录内）。

规格标识（仓库名）：`1.19-amoled-390x390-qspi-co5300`
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| AM119Q390390FLS2 | <img alt="AM119Q390390FLS2" src="./versions/AM119Q390390FLS2/images/product.png" width="120" /> | [简介](#am119q390390fls2) | [完整资料](./versions/AM119Q390390FLS2/) |
...
完整产品页、规格书与示例：[versions/AM119Q390390FLS2/](./versions/AM119Q390390FLS2/)
